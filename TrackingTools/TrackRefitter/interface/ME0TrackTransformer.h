...
namespace reco {class TransientTrack; class RealME0Muon;}
...
public:
  ...
  virtual std::vector<Trajectory> transform(const reco::RealME0Muon&, const edm::Handle<reco::GenParticleCollection>&) const;
