...
vector<Trajectory> ME0TrackTransformer::transform(const reco::RealME0Muon& oldMe0Muon, const Handle<reco::GenParticleCollection>& genmuoncoll) const {
  ...
  const ME0Segment me0Segment = oldMe0Muon.me0segment(); 
...
// 		<< gp.pt() << std::endl; 
  ...
  //Should this change away from 560?
