...
process.Test = cms.EDAnalyzer("ME0MuonAnalyzer",
                              ...
                              HistoFile = cms.string('ME0MuonAnalyzerOutput_DelRForTrack_ME0TrackerMuon_Loose.root'),
                              HistoFolder = cms.string('ME0MuonAnalyzerOutput_DelRForTrack_ME0TrackerMuon_Loose'),
...
process.PoolSource.fileNames = [
    ...
    'file:/afs/cern.ch/work/d/dnash/ME0Segments/ForRealSegmentsOnly/ForFullReco/WithME0RecoCommit/forME0MuonBackPortWithAll/CMSSW_6_2_0_SLHC21/src/step3.root'
]
