...
# with command line options: step2 -s RECO --conditions auto:run2_mc --magField 38T_PostLS1 --datatier GEN-SIM-RECO --geometry Extended2015MuonGEMDev,Extended2015MuonGEMDevReco --eventcontent FEVTDEBUGHLT --era Run2_25ns --customise=SLHCUpgradeSimulations/Configuration/fixMissingUpgradeGTPayloads.fixRPCConditions,SLHCUpgradeSimulations/Configuration/me0Customs.customise -n 10 --no_exec --filein file:out_digi.root --fileout out_reco.root --python_filename SingleMuPt100_cfi_customRECO_Extended2015MuonGEMDev_RPCGEMME0Customs_cfg.py
...
process.load('Configuration.StandardSequences.TestReconstruction_cff')
